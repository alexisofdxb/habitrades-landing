  ...
  return (
    <section id="benefits" className="scroll-mt-24 px-4 py-24 sm:px-6 sm:py-32 min-[810px]:py-36">
      <div className="mx-auto w-full max-w-[1080px]">
        ...
        <div
          ref={scrollRef}
          className="-mx-4 mt-10 overflow-x-auto px-4 [-ms-overflow-style:none] [scrollbar-width:none] snap-x snap-mandatory sm:mt-14 [&::-webkit-scrollbar]:hidden min-[1000px]:mx-0 min-[1000px]:overflow-visible min-[1000px]:px-0 min-[1000px]:snap-none"
        >
                ...
                {imageAnchor === "bottom" ? (
                  ...
                  >
                    <Image
                      ...
                      className="pointer-events-none absolute bottom-0 left-1/2 h-auto max-w-none -translate-x-1/2"
                      style={{
                        width: `${phoneScale * 78}%`,
                      }}
                    />
